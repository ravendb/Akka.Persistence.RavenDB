...
{
    public sealed class RavenDbSnapshotOptions : SnapshotOptions, IRavenDbOptions
    {
        ...
        public void Apply(AkkaConfigurationBuilder builder)
        {
            ...
            var setup = builder.Setups.FirstOrDefault(s => s is RavenDbSnapshotSetup) as RavenDbSnapshotSetup;
            setup ??= new RavenDbSnapshotSetup();
